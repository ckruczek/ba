...
Der Startprozess unterteilt sich in drei Schritte:
	...
	\begin{enumerate}
		\item{\textbf{Startup-Code}}\\
		 ...
		 \item{\textbf{Exception Handler}}\\
		 \label{draft:exceptionHandler}
			Exceptions k\"onnen von externen oder internen Ressourcen ausgel\"ost werden. Damit der Prozessor wei{\ss} wo er im Falle einer Exception hinspringen muss, schreibt ARM eine Struktur vor die eingehalten werden muss \parencite[vgl.][54]{archManI}. 
			\begin{figure}[h]
				\centering
...
Sobald die Stacks alle initialisiert sind erfolgt der Sprung in die \texttt{main} Routine des Betriebssystem. Ab hier finden nun weitere Schritte statt um das System fertig zu initialisieren.
	\end{enumerate}
\section{E2 - Interrupt-Controller}
Ein Interrupt-Controller stellt in einem Betriebssystem die Schnittstelle zwischen den Exceptions und dem System dar. Es gibt zwei Arten von Controllern:
\begin{dinglist}{227}
...
\section{E3 - Interrupt-Service Routinen}
...
\section{E5 - Prozessmanagment}
\subsection{Prozesslayout}
